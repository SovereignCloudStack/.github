![SCS cloud image](/profile/images/Headerbild_SCS_LinkedIn.png)
...
Good starting points are the [docs](https://github.com/SovereignCloudStack/Docs) repository and the '[How to contribute page](https://docs.scs.community/community)' page on the docs website. The SCS Standards are in the standards repository and are easiest to navigate on the aforementioned [Docs Website](https://docs.scs.community/).
...
- [uStack](https://gitlab.com/uhurutec/stack/ustack) - uStack is a GitOps-based integration layer for OpenStack on Kubernetes using YAOOK, similar to OSISM with OpenStack Kolla-Ansible.
- [Yaook](https://yaook.cloud) - Yaook is a lifecycle management tool and distribution for OpenStack on top of Kubernetes.
